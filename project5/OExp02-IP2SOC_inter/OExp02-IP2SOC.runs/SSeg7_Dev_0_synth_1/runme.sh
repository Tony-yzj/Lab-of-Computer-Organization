...
HD_PWD='D:/14.7/LabofCOAD/project1/OExp02-IP2SOC/OExp02-IP2SOC.runs/SSeg7_Dev_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SSeg7_Dev_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SSeg7_Dev_0.tcl
