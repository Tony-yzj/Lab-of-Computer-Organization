...
HD_PWD='D:/14.7/LabofCOAD/project5/OExp02-IP2SOC_pipline/OExp02-IP2SOC.runs/ROM_P_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_P.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_P.tcl
